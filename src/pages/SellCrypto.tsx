      ...
      <MobileLayout hideNav>
        <PageTransition>
          <div className="min-h-screen flex flex-col items-center justify-center px-6">
            ...
            <p className="text-muted-foreground text-center mb-2">Send {amount} {selectedAsset.symbol} to the address provided</p>
          ...
          <div className="px-4 pt-4">
            ...
            <div className="bg-card border border-border rounded-xl p-5 space-y-4 mb-6">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2"><CryptoIcon symbol={selectedAsset.symbol} size="sm" /><span className="text-sm text-foreground">{selectedAsset.name}</span></div>
              </div>
