...
const AdOffer2000 = () => {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ zoom: 0.9 }}>
      ...
      <div className="mx-auto max-w-[1400px] space-y-[120px] px-4 pb-[120px] pt-[72px] sm:px-6 lg:space-y-[258px] lg:px-10 lg:pb-[258px] lg:pt-[160px] xl:px-16">
