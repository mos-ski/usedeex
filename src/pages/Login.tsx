    ...
    <MobileLayout hideNav>
      <div className="min-h-screen flex flex-col px-6 pt-16 pb-8">
        ...
        <div className="space-y-4 flex-1">
          ...
          <button className="text-primary text-sm self-end ml-auto block">Forgot Password?</button>

          {/* Login Button */}
          <button
            onClick={handleLogin}
            className="w-full h-12 bg-primary rounded-xl text-primary-foreground font-semibold text-base mt-4"
          >
            Log In
          </button>
